...
import com.ex.framework.database.impl.DaoSupportImpl;
...
@Configuration
@ConditionalOnProperty(value = "mall.product", havingValue = "stand")
public class DataSourceConfig {
    ...
    //region jdbcTemplate配置
    /**
     * 商品库jdbcTemplate
     * @param dataSource 商品库数据源
     * @return
     */
    @Bean(name = "goodsJdbcTemplate")
    @Primary
    public JdbcTemplate goodsJdbcTemplate(@Qualifier("goodsDataSource") DataSource dataSource){
