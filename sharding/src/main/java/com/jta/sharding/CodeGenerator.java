...
import com.jta.sharding.mappers.base.BaseMapper;
import com.jta.sharding.services.base.BaseService;
import com.jta.sharding.services.base.BaseServiceImpl;
...
public class CodeGenerator {
     ...
     * 父包和子包设置
     */
    private String parentPackage = "com.jta.sharding";
     ...
     * 数据源设置
     */
    private String dataSourceUrl = "jdbc:mysql://localhost:3306/database0?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8";
    ...
    public static void main(String[] args) {
        new CodeGenerator()
                .generate("Goods0", "goods_0", IdType.AUTO)
                .generate("Goods1", "goods_1", IdType.AUTO);
    }
