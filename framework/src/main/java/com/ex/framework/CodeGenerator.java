...
import com.ex.framework.mapper.base.BaseMapper;
import com.ex.framework.service.base.BaseService;
import com.ex.framework.service.base.BaseServiceImpl;
...
public class CodeGenerator {
    ...
    //父包和子包设置
    private String parentPackage = "com.ex.framework";
     ...
     * 数据源设置
     */
    private String dataSourceUrl = "jdbc:mysql://localhost:3306/world?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8";
    ...
    public static void main(String[] args) {
        new CodeGenerator()
                .generate("City", "city", IdType.AUTO);
    }
